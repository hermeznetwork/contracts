...
describe("Hermez ERC 20", function () {
  ...
  describe("Withdraw circuit", function () {
    ...
    it("test instant withdraw circuit", async function () {
      ...
      const prove = await snarkjs.groth16.fullProve(input, path.join(__dirname, "./circuits/withdraw.wasm"), path.join(__dirname, "./circuits/withdraw_hez3_0001.zkey" ));
      ...
      console.log("directly prover");
      console.log(gasVerifiProver.toNumber());
      ...
      console.log(gasVerifiProof.toNumber());
      ...
      console.log(gasVerifiInvalid.toNumber());
