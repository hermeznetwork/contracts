...
import "./HermezHelpersV2.sol";

import "@openzeppelin/contracts/math/SafeMath.sol";

contract InstantWithdrawManagerV2 is HermezHelpersV2 {
        ...
        returns (bool)
    {
        ...
        ) = unpackBucket(buckets[bucketIdx]);
     ...
     */
    function updateBucketsParameters(uint256[] memory newBuckets)
        external
        onlyGovernance
    {
    ...
    function safeMode() external onlyGovernance {
        ...
        nBuckets = 1;
        buckets[0] = packBucket(0xFFFFFFFF_FFFFFFFF_FFFFFFFF, 0, 0, 1, 0, 0);
    ...
    function unpackBucket(uint256 bucket)
        public
        pure
        returns (
            uint256 ceilUSD,
